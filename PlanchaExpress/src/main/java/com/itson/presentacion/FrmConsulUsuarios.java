...
public class FrmConsulUsuarios extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FrmConsulUsuarios
     */
    ...
    private void initComponents() {
        ...
        lblUsuario.setText("Consultar usuarios");
        ...
        tblUsuarios.setFont(new java.awt.Font("Kannada MN", 0, 14)); // NOI18N
        ...
        pnlFondo.add(scrlUsuarios, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 140, 400, 210));
    ...
    public void llenarTablaServ() {
        List<Usuario> usuarios = logica.recuperarUsuarios();
        DefaultTableModel modelo = (DefaultTableModel) this.tblUsuarios.getModel();
        modelo.setRowCount(0);
        for (Usuario usuario : usuarios) {
            Object[] filaNueva = {usuario.getId(), usuario.getNombre()};
        ...
        if (fila == -1) {
            ...
            folio = (Long) this.tblUsuarios.getValueAt(fila, 0); // Primera columna
        }
        return folio;
    }
